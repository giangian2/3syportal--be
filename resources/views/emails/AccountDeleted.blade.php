...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office"> 
 <head> 
  ...
  <title>chiusura account</title><!--[if (mso 16)]>
    <style type="text/css">
               ...
               <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                 ...
                 <tr> 
                  <td class="es-m-p0r es-m-p20b" valign="top" align="center" style="padding:0;Margin:0;width:560px"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr> 
                      <td align="left" style="padding:0;Margin:0;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:24px;color:#EFEFEF;font-size:16px">Ciao <strong>{{$mailData['name']}}</strong>,<br><br>Ti scriviamo per ringraziarti di aver lavorato con noi.<br>Il tuo account da questo momento non è più accessibile.<br><br><br><br><br><br>Grazie mille.<br><br><br><strong>Amministrazione</strong><br><strong>3sy S.r.l</strong></p></td> 
                     </tr> 
                   </table></td> 
                 </tr> 
               </table></td> 
